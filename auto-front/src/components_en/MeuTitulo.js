    ...
    return (
        <div className="mt-row">
            ...
            <div className="mt-row-element" id="aa4">
                <p className="mt-label">Profitability</p>
                <p>{rentabilidade}</p>
            </div>
            ...
            <div className="mt-row-element" id="aa6">
                <button onClick={openTrocarModal} className={`mtbutton ${getTipoClass(tipo)}`}>Exchange</button>
                <button onClick={openResgatarModal} className={`mtbutton ${getTipoClass(tipo)}`}>Redeem</button>
            </div>
